...
@section('title')
{{ is_numeric(__( ucfirst( request()->segment(count(request()->segments())) ) )) ? $message->name : '' }}
@endsection
                            ...
                            <div class="d-flex align-items-center flex-wrap mr-1">
                                ...
                                <div class="d-flex align-items-baseline flex-wrap mr-5">
                                    ...
                                    <ul
                                        ...
                                        <li class="breadcrumb-item text-muted">
                                            <a href="{{ route(Route::currentRouteName(), [app()->getlocale(), $message->id ] ) }}"
                                                class="text-muted">
                                                {{ __('View') }}
                                            </a>
                                        </li>
                        ...
                        <div class="container">
                            ...
                            <div class="card card-custom card-stretch gutter-b">
                                <div class="card-body p-15 pb-20">
                                    <div class="row mb-17">
                                        <div class="col-xxl-5 mb-11 mb-xxl-0">
                                            <div
                                                class="d-flex align-items-center border-dashed card-rounded p-5 p-lg-10 mb-14">
                                                <!--begin::Section-->
                                                <div class="text-center flex-shrink-0 me-7 me-lg-13">
                                                    <!--begin::Avatar-->
                                                    <div class="symbol symbol-70px symbol-circle mb-2">
                                                        <img src="{{ asset('metronic-template/v7/assets/media/icons/duotone/General/User.svg') }}"
                                                            class=""
                                                            alt="{{ asset('metronic-template/v7/assets/media/icons/duotone/General/User.svg') }}">
                                                    </div>
                                                    <!--end::Avatar-->
                                                    <!--begin::Info-->
                                                    <div class="m-5">
                                                        <span
                                                            href="{{ route(Route::currentRouteName(), [app()->getlocale(), $message->id ] ) }}"
                                                            class="text-gray-700 fw-bolder">{{ $message->name }}</span>
                                                        <span class="text-gray-400 fs-7 fw-bold d-block mt-1"><i
                                                                class="flaticon2-black-back-closed-envelope-shape"></i>
                                                            {{ $message->email }}</span>
                                                        <span class="text-gray-400 fs-7 fw-bold d-block mt-1"><i
                                                                class="flaticon2-phone"></i>
                                                            {{ $message->phone_number }}</span>
                                                    </div>
                                                    <!--end::Info-->
                                                </div>
                                                <!--end::Section-->
                                                <!--begin::Text-->
                                                <div class="m-5 fs-6">
                                                    <div class="text-muted fw-bold lh-lg m-5">
                                                        <textarea name="" id="" cols="30"
                                                            rows="10">{{ $message->messages }}</textarea>
                                                    </div>
                                                </div>
                                                <!--end::Text-->
                                            </div>
                                ...
                                <div class="card-footer d-flex justify-content-between">
                                    ...
                                    <form
                                        action="{{ route(Request::segment(3) . '.destroy', [app()->getlocale(), $message->id ] ) }}"
                                        method="post">
                                        @method('delete')
                                        @csrf
                                        ...
                                        <div class="example-preview">
                                            ...
                                            <div class="modal fade" id="exampleModalSizeSm" tabindex="-1"
                                                aria-labelledby="exampleModalSizeSm" style="display: none;"
                                                aria-hidden="true">
