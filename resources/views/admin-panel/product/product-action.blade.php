<span class="dtr-data d-flex">
    <a href="{{ route(Request::segment(3) . '.show', [app()->getlocale(), $model->id ] ) }}"
    ...
    <a href="{{ route(Request::segment(3) . '.edit', [app()->getlocale(), $model->id ] ) }}"
    ...
    <form action="{{ route(Request::segment(3) . '.destroy', [app()->getlocale(), $model->id ] ) }}" method="post">
        @method('delete')
        @csrf
