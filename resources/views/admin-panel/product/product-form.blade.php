                                ...
                                <form
                                    ...
                                    <form action="{{ route(Request::segment(3) . '.store', app()->getlocale() ) }}"
                                                    ...
                                                    <div class="col-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                value="{{ $product->{'name_' . $lang } }}{{ request()->segment(count(request()->segments())) == 'create' ? old('name_' . $lang) : '' }}" />
                                        ...
                                        <div class="card-footer d-flex justify-content-between">
                                            ...
                                            <button type="submit" title="{{ $product->id ? __('Edit') : __('Create') }}"
                                                class="btn {{ $product->id ? 'btn-warning' : 'btn-primary' }} font-weight-bolder">
                                                <span class="svg-icon svg-icon-md">
                                                    @if($product->id)
                                                    <span class="svg-icon svg-icon-md {{ $product->id ? 'svg-icon-dark' : '' }}">
